...
export default function Home() {
  return (
    <div>
        ...
        {/* Intro */}
        <div style={{marginTop:"80px", width: "100%", backgroundColor:"rgb(255,255,255)", display:"flex", justifyContent:'space-around'}}>
        ...
        <section id='feature'>
          <div>
            ...
            <div>
              <div>
                <iframe src='https://www.youtube.com/watch?v=xNRJwmlRBNU&t=320s' title='your video'></iframe>
                <div>
                    <h2>Tạo và quản lý bài tập, kiểm tra bằng AI</h2>
                    <p>Không cần soạn thảo các công thức phức tạp, mọi thứ được nhận diện hoàn toàn tự động với SHub Classroom. Bên cạnh đó, bạn còn được cung cấp đa dạng các tùy chỉnh chuyên sâu theo từng nhu cầu sử dụng.</p>
                </div>
              </div>
              <div>
                <div>
